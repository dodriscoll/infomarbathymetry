...
<!--     <script src="scripts/tools/Leaflet.draw/dist/leaflet.draw-src.js" type="text/javascript"></script> -->
	...
	<script src="scripts/display/leaflet.spin.js" type="text/javascript"></script>
...
<body>
	<div id="container">
		<div id="map"></div>
		<div id="form-Shading" class="leaflet-bar">
        ...
        <div id="depth-ranges" draggable="true" class="leaflet-bar">
			...
			<div><div style="display:inline-block; vertical-align:top; text-align:left; padding:5px 0 0 0;"><p style="margin-bottom:40px;">	
					<label for="to">
							Maximum value:
                    <input id='to' type="text" value='50' name='to' title="Change maximum depth (or elevation) value displayed, use - sign for depths below sea level and + sign for elevation above sea level"></label></p>
					                        <label for="from">
                                 Minimum value:
                            <input id='from' type="text" value='-5223' name='from' title="Change minimum depth (or elevation) value displayed, use - sign for depths below sea level and + sign for elevation above sea level">
                        </label></div>
		...
		<div id="uploadCSV" class="leaflet-bar">
    ...
    <div id="latlng" class="leaflet-bar">
        <script>
            L.control.mousePosition().addTo(map);
        </script>
    </div>
    <div id="scale-bar" class="leaflet-bar">
        <script>
